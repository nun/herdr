...
| Close pane | `prefix+x` |
| Swap panes | `prefix+shift+arrows` |
...
| Last visited workspace | `prefix+shift+l` |
| Pin/unpin workspace | `prefix+shift+f` |
...
focus_pane_right = ["prefix+right", "ctrl+alt+l"]
