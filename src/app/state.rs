...
pub struct ViewState {
    ...
    /// Leading segment of the tab bar reserved for the active workspace badge
    /// shown when the sidebar is hidden. Empty when no badge is drawn.
    pub tab_badge_rect: Rect,
...
pub struct AppState {
    ...
    /// Update the outer terminal window title to the active space name when it
    /// changes. When false, Herdr leaves the outer terminal title untouched.
    pub terminal_title_follows_space: bool,
...
impl AppState {
    ...
    pub fn test_new() -> Self {
        Self {
            ...
            mouse_capture: true,
            terminal_title_follows_space: true,
