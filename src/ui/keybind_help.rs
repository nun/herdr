...
pub(super) fn keybind_help_groups(app: &AppState) -> Vec<HelpGroup> {
    ...
    let workspace_tab = vec![
        ...
        help_entry(keybind_label(&kb.pin_workspace), "pin/unpin space"),
        ...
        help_entry(
            keybind_label(&kb.previous_attention_agent),
            "previous agent needing attention",
        ),
        help_entry(
            keybind_label(&kb.next_attention_agent),
