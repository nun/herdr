...
# focus_attention_agent = "prefix+a" # focus the next blocked or done agent; empty disables
...
# next_tab = "prefix+n"
# last_tab = ""           # optional, unset by default; bind e.g. "prefix+tab" to toggle to the previous tab
...
# Show the prefix-mode hint bar at the bottom while prefix mode is active.
# prefix_hint = true
