...
# previous_attention_agent = "" # optional, unset by default; blocked or unseen done
# next_attention_agent = ""     # optional, unset by default
...
# last_tab = "prefix+l"   # toggle the previously visited tab in the active workspace
# last_workspace = "prefix+shift+l" # toggle the previously visited workspace
