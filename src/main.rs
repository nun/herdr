...
# next_attention_agent = ""     # optional, unset by default; skips agents that aren't blocked/done
...
# next_tab = "prefix+n"
# last_tab = "prefix+l"  # toggle to the last visited tab in the active workspace
